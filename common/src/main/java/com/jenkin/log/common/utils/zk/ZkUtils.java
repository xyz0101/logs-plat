...
import com.jenkin.log.common.entity.TopicInfo;
import com.jenkin.log.common.utils.DBUtils;
import com.jenkin.log.common.utils.HttpUtils;
...
//    闭锁，阻塞事件监听线程
    ...
    private static final String ZK_ADDR = "mall.jenkin.tech:7681";
    ...
    static{
        ...
        client = CuratorFrameworkFactory.newClient(ZK_ADDR,
    ...
    private static boolean needResolve(String topic) {
        TopicInfo topicInfo = DBUtils.quickExeSelectResultForObject(DBUtils.getDBConnect(),
                "select * from topic_info where topic_name = ?", TopicInfo.class, topic);
        return topicInfo!=null&&"Y".equals(topicInfo.getNeedResolve());
    }
