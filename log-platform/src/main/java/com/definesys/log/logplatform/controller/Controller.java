package com.definesys.log.logplatform.controller;
...
import com.definesys.log.logplatform.service.LogPlatformService;
...
public class Controller {
    ...
    public Response<Integer> getAvailablePartitionNumber(){
        int nums = logPlatformService.getAvailablePartitionNumber();
